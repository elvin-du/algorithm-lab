...
func ReconstructBinaryTree(preorder, inorder []int) *BinaryTree {
...
func reconstructBinaryTree(preorder []int, prestart, preend int, inorder []int, instart, inend int) *BinaryTreeNode {
